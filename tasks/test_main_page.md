...
7) Проверка элемента на странице
   ...
   upd: в задаче #60 Проанализировать возможность убрать implicitly_wait из задач с page_object
   (issue_delete_implicitly_wait) убрали неявные ожидания. Причина: в результате анализа прогона тестов с наличием
   и отсутствием неявного ожидания падение при удалении строк с implicitly_wait воспроизвести не удалось.
