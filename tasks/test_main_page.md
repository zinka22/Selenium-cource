...
7) Проверка элемента на странице
   ...
   неявным ожиданием.
    ...
    1. В конструктор BasePage добавим команду для неявного ожидания со значением по умолчанию в 10:
       ...
       upd: в задаче [#54](https://github.com/zinka22/Selenium-cource/issues/54) убрали неявные ожидания.
       Причина: в результате анализа прогона тестов с наличием и отсутствием неявного ожидания падение при удалении
       строк с `implicitly_wait` воспроизвести не удалось.
